...
- Setup a Hazelcast cluster, e.g. by Docker Compose
- Run it with extra Spring profile: `SPRING_PROFILES_ACTIVE=default,hazelcast mvn clean spring-boot:run`
- Optionally, setup the Hazelcast management center to manage and visualize Hazelcast clusters.
